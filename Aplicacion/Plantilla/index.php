    ...
    <div class="row">
      <div class="col-lg-4 col-sm-6 portfolio-item">
        ...
        do {
          ...
          echo '<form action="../Aplicacion/descripcion.php" method="post">';
          echo '<input type="hidden" name="titulo" value="'. $row['titulo'] . '">';
          echo '<input type="hidden" name="precio" value="'. $row['precio'] . '">';
          echo '<input type="hidden" name="habitaciones" value="'. $row['habitaciones'] . '">';
          echo '<input type="hidden" name="telefono" value="'. $row['telefono'] . '">';
          echo '<input type="hidden" name="distancia" value="'. $row['distancia'] . '">';
          echo '<input type="hidden" name="imagen" value="'. $row['imagen'] . '">';
          echo '<input type="hidden" name="descripcion" value="'. $row['descripcion'] . '">';
          echo ' <h4 class="card-title">';
          echo '<input type="submit" value="'.$row['titulo'].'">';
          echo '</h4>';
          echo '</form>';
          echo ' <p class="card-text">
                  <b>Precio:</b> ' . $row['precio'] . '
                  <br><b> Habitaciones:</b> ' . $row['habitaciones'] . '
                  <br> <b>Distancia al Montessori:</b> ' . $row['distancia'] . '
                  <br> <b>Telefono:</b> ' . $row['telefono'] . '
                </p>';
          echo ' </div></div></div><div class="col-lg-4 col-sm-6 portfolio-item">';
      ...
      <?php
      echo '<div style="position: relative; width: 100%; left: 45%;">';
      for ($i = 1; $i <= $totalPaginas; $i++) {
        echo "<a style='padding: 3px;' href='?pagina=" . $i . "'>" . $i . "</a> ";
      }
      echo '</div>';
      ?>
