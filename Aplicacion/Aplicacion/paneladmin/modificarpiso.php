...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <form action="../ControladoresPHP/modificarpiso.php" method="post">
            <br>
            <p>Selecciona una opcion del deplegable, presiona modificar y cambia los valores; selecciona modificar del formulario para aceptar los cambios</p> <br>
            ...
            <div class="info">
                <form name="registro" action="../ControladoresPHP/modificarpiso.php" method="post">
                    <input type="text" name="descripcion" placeholder="Descripcion del piso" required value="<?php echo $_SESSION['descripcion'] ?>" required><br>
